...
def reconstruct_path(
    ...
    for i, point in enumerate(path_points):
        ...
        if i == 0:
            logger.info(f"First waypoint: time_hours={point.time_hours}, departure_time={departure_time.isoformat()}, arrival_time={arrival_time.isoformat()}")
...
def calculate_isochrone_route(
    ...
    logger.info(f"Departure time parsed: {departure_time.isoformat()}")
